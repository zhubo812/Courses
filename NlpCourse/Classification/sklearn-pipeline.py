...
# 选取下面的8类
from Classification.DataFetcher import fetch_data


# news = fetch_data(subset='all')
...
#                                     categories=selected_categories,shuffle=True, random_state=20,
#                                     remove=('headers','footers','quotes'))
# newsgroups_test=fetch_20newsgroups(subset='test',
#                                     categories=selected_categories,shuffle=True, random_state=20,
#                                     remove=('headers','footers','quotes'))

newsgroups_train= fetch_data(subset='train',
                                         categories=selected_categories, shuffle=True, random_state=20,
                                         remove=('headers','footers','quotes'))
newsgroups_test=fetch_data(subset='test',
                                    categories=selected_categories,shuffle=True, random_state=20,
                                    remove=('headers','footers','quotes'))
