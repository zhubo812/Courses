...
1. 音位是能区别意义的语音单位。
	- 音素音质上的差别有两种性质：
		- 一种是对立性差别汉语的/p/—/p'/,法语的/a/—/ɑ/
		- 一种是非对立性差别汉语的/a/—/ɑ/,英语的/p/—/p'/
2. 音位是最小的语音单位。
3. 音位总是属于某种特定的语言或方言的。
~~~~
...
~~~~
##### 音位变体的类型
根据音位变体在语音环境中出现的情况不同，可分为自由变体和条件变体。
~~~~
...
- 普通话/a/的变体
1. [a]，出现在韵尾[-i、-n]之前，例如：爱[ai]，该[kai]，安[an]，愿[yuan]；
...
~~~~
- 调位
如‚<font color='red'>乌‚吴‚五‚务</font>都是‚wu，只是由于音位声调的不同而区别意义的。
这种具有区别意义作用的音高变化，就是调位。
~~~~
- 重位
能区别词的语音形式的轻重音就是重位。 如：<font color='red'>莲子/帘子</font>。 
...
![jhgx](../Intro2Linguistics/img/c3/zhgx.png)
